...
import logo from '../../src/assets/Golden Closet Studio_Logo_c2c.svg';
...
const Navigation = () => {
  ...
  return (
    ...
    max-w-[100px] sm:max-w-[120px] md:max-w-[120px] 
    w-full h-auto ${isScrolled ? 'brightness-100' : 'brightness-90'}`}
          />
